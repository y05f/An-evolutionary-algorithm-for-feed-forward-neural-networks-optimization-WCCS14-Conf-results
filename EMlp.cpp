...
const float probNM = 0.6;         //Probabilité de mutation des neurones
const float probNR = 0.8;         //Probabilité de mutation des réseaux
const float probBP = 0.7;
const float etaBP = 0.1;
